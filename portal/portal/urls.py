...
urlpatterns += [
    ...
    path( 'password_change/', auth_views.password_change, { 'template_name' : 'gentelella/password_change.html' }, name='password_change' ),
    path( 'password_change_done/', auth_views.password_change_done, { 'template_name' : 'gentelella/password_change_done.html' }, name='password_change_done' ),
